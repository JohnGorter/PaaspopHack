...
<head>
  ...
  <script type="module" src="../paper-ripple.js"></script>
  ...
  suite('remove a paper ripple', function () {
    ...
    test('add and remove a paper-ripple', function (done) {
      ...
      ripple.addEventListener('transitionend', function() {
        ...
        dom(rippleContainer).removeChild(ripple);
        done();
      });
      dom(rippleContainer).appendChild(ripple);
    ...
    test('reuse a paper-ripple', function (done) {
      ...
      ripple.addEventListener('transitionend', function() {
        expect(ripple.parentNode).to.be.ok;
        dom(document.body).removeChild(ripple);
        done();
      });
      dom(document.body).appendChild(ripple);
      // NOTE: shadydom applies distribution asynchronously
      // for performance reasons webcomponents/shadydom#120
      // Flush to force distribution.
      window.ShadyDOM && window.ShadyDOM.flush();
